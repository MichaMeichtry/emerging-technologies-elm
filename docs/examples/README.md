...
Each example is self-contained and runnable directly in the browser via [Ellie](https://ellie-app.com) - no local setup needed.
...
| 05  | [Weather App](./05-weather-app/README.md)                     | HTTP and JSON Decoding            | [Open](https://ellie-app.com/yvk66GngrgZa1) |