...
var $author$project$Main$NoteLoaded = function (a) {
	return {$: 'NoteLoaded', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$loadNote = _Platform_incomingPort('loadNote', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$loadNote($author$project$Main$NoteLoaded);
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$saveNote = _Platform_outgoingPort('saveNote', $elm$json$Json$Encode$string);
		...
		if (msg.$ === 'NoteChanged') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{note: newNote}),
				$author$project$Main$saveNote(newNote));
		} else {
			var stored = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'margin', '60px auto'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Persistent Note')
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Your note is saved automatically and survives page reloads.')
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('Start typing your note…'),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$isEmpty(model.note) ? 'Nothing saved yet.' : ($elm$core$String$fromInt(
							$elm$core$String$length(model.note)) + ' character(s) saved.'))
					]))
			]));
};
